...
//delete Ridesharing account from both db
export const deleteRideAccount =async(req,res) => {
    const userId = req.params.userId;
    ...
    try {
        ...
        // Find and delete the Ridesharing document
        await RideModel.findOneAndDelete({ user: userId });
